...
class Shape:
    def __init__(self, position=(0, 0, 0), size=1.0, color=(1, 1, 1), textureid=None):
        self.position = list(position)
        self.size = size
        self.color = list(color)
        self.rotation = [0, 0, 0]  # rotation angles in degrees for x, y, z
        self.textureid = textureid  # texture ID for texturing, if any
...
class Cube(Shape):
    def __init__(self, position=(0, 0, 0), size=1.0, color=(1, 1, 1), rotation=[0,0,0], textureid=None):
        super().__init__(position, size, color, textureid)
    ...
    def render(self):
        ...
        gl.glTexCoord2f(1, 0); gl.glVertex3f(s, 0, 0)
        gl.glTexCoord2f(1, 1); gl.glVertex3f(s, s, 0)
        gl.glTexCoord2f(0, 1); gl.glVertex3f(0, s, 0)

        # Ba
        gl.glNormal3f(0, 0, 1)
        gl.glTexCoord2f(0, 0); gl.glVertex3f(0, 0, s)
        gl.glTexCoord2f(1, 0); gl.glVertex3f(s, 0, s)
        gl.glTexCoord2f(1, 1); gl.glVertex3f(s, s, s)
        gl.glTexCoord2f(0, 1); gl.glVertex3f(0, s, s)

        # L
        gl.glNormal3f(-1, 0, 0)
        gl.glTexCoord2f(0, 0); gl.glVertex3f(0, 0, 0)
        gl.glTexCoord2f(1, 0); gl.glVertex3f(0, 0, s)
        gl.glTexCoord2f(1, 1); gl.glVertex3f(0, s, s)
        gl.glTexCoord2f(0, 1); gl.glVertex3f(0, s, 0)

        # R
        gl.glNormal3f(1, 0, 0)
        gl.glTexCoord2f(0, 0); gl.glVertex3f(s, 0, 0)
        gl.glTexCoord2f(1, 0); gl.glVertex3f(s, 0, s)
        gl.glTexCoord2f(1, 1); gl.glVertex3f(s, s, s)
        ...
        gl.glTexCoord2f(0, 0); gl.glVertex3f(0, 0, 0)
        gl.glTexCoord2f(1, 0); gl.glVertex3f(s, 0, 0)
        gl.glTexCoord2f(1, 1); gl.glVertex3f(s, 0, s)
        gl.glTexCoord2f(0, 1); gl.glVertex3f(0, 0, s)

        # T
        gl.glNormal3f(0, 1, 0)
        gl.glTexCoord2f(0, 0); gl.glVertex3f(0, s, 0)
...
class Text2D(Shape):
    def __init__(self, position=(0, 0, 0), text="", color=(1, 1, 1), scale=1.0, thickness=2.0,center=False, font=GLUT_STROKE_ROMAN): # type: ignore
    ...
    def render(self):
        ...
        gl.glLineWidth(self.line_thickness)  # increase this value for thicker letters
...
class Quad(Shape):
    ...
    def render(self):
        ...
        gl.glVertex3f(0,         0,         0); gl.glTexCoord2f(0, 0)
        gl.glVertex3f(self.size, 0,         0); gl.glTexCoord2f(1, 0)
        gl.glVertex3f(self.size, self.size, 0); gl.glTexCoord2f(1, 1)
        gl.glVertex3f(0,         self.size, 0); gl.glTexCoord2f(0, 1)
        gl.glEnd()
        self._post_render()
